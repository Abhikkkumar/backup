...
export default function PhotoPrivacy({ setShowPhotoPrivacy }) {
  ...
  //to get photoBlocked data of current logged in user
  function currentUserData() {
    ...
    axios
      ...
      .then((result) => {
        setLocked(result.data.user.photoBlocked);
      })
    ...
    <div className="darkBg">
      <div className="lmt-shr-centered">
        <div className="limited-sharing">
          <h4>My Profile Photo Privacy</h4>
          <button
