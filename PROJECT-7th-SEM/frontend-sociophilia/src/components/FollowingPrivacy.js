...
export default function FollowingPrivacy({ setShowFollowingPrivacy }) {
  ...
  //to get followingBlocked data of current logged in user
  function currentUserData() {
    ...
    axios
      ...
      .then((result) => {
        setLocked(result.data.user.followingBlocked);
      })
...
// to get data of all registered users
  ...
  function lockUser(userId) {
    axios
      .put(
        "http://localhost:5000/lockUser",
        {
          location: "followingBlocked",
          userId,
        },
        {
          headers: {
  ...
  function unlockUser(userId) {
    axios
      .put(
        "http://localhost:5000/unlockUser",
        {
          location: "followingBlocked",
          userId,
        },
